...
namespace WebApp.Presentacion.WebMvc5.Models
{
    ...
    public partial class Nt_Grp_CantFindModel : Entity
    {
        ...
        public virtual IEnumerable<Nt_Grp> Nt_Grp { get { return _nt_Grp; } set { if (!Equals(value, _nt_Grp)) { _nt_Grp = value; } } }
    	private IEnumerable<Nt_Grp> _nt_Grp;
